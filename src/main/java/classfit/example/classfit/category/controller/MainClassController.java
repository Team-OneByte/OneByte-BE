...
public class MainClassController {
    ...
    public CustomApiResponse<List<AllMainClassResponse>> showMainClass(
        @AuthMember Member findMember) {
    ...
    public CustomApiResponse<?> deleteMainClass(@AuthMember Member findMember,
    ...
    public CustomApiResponse<MainClassResponse> updateMainClass(@AuthMember Member findMember,
                                                                @PathVariable(name = "mainClassId") Long mainClassId,
        ...
        return CustomApiResponse.success(updateMainClass, 200, "DELETED");
    }
