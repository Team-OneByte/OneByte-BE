...
public record CalendarCategoryListResponse(
    ...
    public static CalendarCategoryListResponse of(
        final List<CalendarCategoryResponse> personalCategories,
        final List<CalendarCategoryResponse> sharedCategories
    ) {
