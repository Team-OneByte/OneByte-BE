...
public class AttendanceStatisticsController {
    ...
    public CustomApiResponse<List<StatisticsDateResponse>> getAttendanceStaticsByDate(
        ...
        return CustomApiResponse.success(statisticsDate, 200, "SUCCESS");
    }
    ...
    public CustomApiResponse<List<String>> getAttendanceDetailsByDateAndStatus(
        ...
        return CustomApiResponse.success(studentDetails, 200, "SUCCESS");
    }

    @GetMapping("/member")
    @Operation(summary = "클래스 구성원별 통계", description = "구성원별 출결 통계 조회 시 사용되는 api 입니다.")
    public CustomApiResponse getAttendanceStaticsByMember(
        @AuthMember Member member,
        @Parameter(description = "조회 시작 기간")
        @RequestParam(value = "startDate") LocalDate startDate,
        @Parameter(description = "조회 끝 기간")
